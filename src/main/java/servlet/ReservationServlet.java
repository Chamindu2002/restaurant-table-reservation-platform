...
//
//            String msg = service.createReservation(
//                    req.getParameter("id"),
...
//
//            String msg = service.updateReservation(
//                    req.getParameter("id"),
//                    req.getParameter("name"),
//                    req.getParameter("date"),
//                    req.getParameter("time"),
...
//
//            String msg = service.deleteReservation(
//                    req.getParameter("id")
//            );
//
//            req.setAttribute("msg", msg);
...
//
//            List<String> results = service.searchReservation("");
//
